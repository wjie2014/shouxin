...
var bufferUtil_1 = require("../utils/bufferUtil"), error_1 = require("./error"), IntervalDT = function() {
    function c(t, i, h, s, r, e, a, f) {
        ...
        this.fraction = 0, t instanceof Buffer) {
            switch (this.type = t[21], this.scaleForSvr = bufferUtil_1.BufferUtil.s(t, 20), 
            this.leadScale = this.scaleForSvr >> 4 & 15, this.secScale = 15 & this.scaleForSvr, 
            this.type) {
              case c.QUA_D:
                this.days = bufferUtil_1.BufferUtil.s(t, 0);
                break;

              case c.QUA_DH:
                this.days = bufferUtil_1.BufferUtil.s(t, 0), this.hours = bufferUtil_1.BufferUtil.s(t, 4);
                break;

              case c.QUA_DHM:
                this.days = bufferUtil_1.BufferUtil.s(t, 0), this.hours = bufferUtil_1.BufferUtil.s(t, 4), 
                this.minutes = bufferUtil_1.BufferUtil.s(t, 8);
                break;

              case c.QUA_DHMS:
                this.days = bufferUtil_1.BufferUtil.s(t, 0), this.hours = bufferUtil_1.BufferUtil.s(t, 4), 
                this.minutes = bufferUtil_1.BufferUtil.s(t, 8), this.seconds = bufferUtil_1.BufferUtil.s(t, 12), 
                this.fraction = bufferUtil_1.BufferUtil.s(t, 16);
                break;

              case c.QUA_H:
                this.hours = bufferUtil_1.BufferUtil.s(t, 4);
                break;

              case c.QUA_HM:
                this.hours = bufferUtil_1.BufferUtil.s(t, 4), this.minutes = bufferUtil_1.BufferUtil.s(t, 8);
                break;

              case c.QUA_HMS:
                this.hours = bufferUtil_1.BufferUtil.s(t, 4), this.minutes = bufferUtil_1.BufferUtil.s(t, 8), 
                this.seconds = bufferUtil_1.BufferUtil.s(t, 12), this.fraction = bufferUtil_1.BufferUtil.s(t, 16);
                break;
    ...
    return c.prototype.encode = function(t) {
        ...
        var o = Buffer.allocUnsafe(24);
        return bufferUtil_1.BufferUtil.f(o, 0, this.negative ? -s : s), bufferUtil_1.BufferUtil.f(o, 4, this.negative ? -r : r), 
        bufferUtil_1.BufferUtil.f(o, 8, this.negative ? -e : e), bufferUtil_1.BufferUtil.f(o, 12, this.negative ? -a : a), 
        bufferUtil_1.BufferUtil.f(o, 16, this.negative ? -f : f), bufferUtil_1.BufferUtil.f(o, 20, t), 
        o;
