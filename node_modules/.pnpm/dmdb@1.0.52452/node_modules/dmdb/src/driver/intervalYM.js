...
var bufferUtil_1 = require("../utils/bufferUtil"), error_1 = require("./error"), IntervalYM = function() {
    function o(t, r, i, h) {
        ...
        this.years = 0, this.months = 0, Buffer.isBuffer(t)) switch (this.scaleForSvr = bufferUtil_1.BufferUtil.s(t, 8), 
        this.leadScale = this.scaleForSvr >> 4 & 15, this.type = t[9], this.type) {
          case o.QUA_Y:
            this.years = bufferUtil_1.BufferUtil.s(t, 0);
            break;

          case o.QUA_YM:
            this.years = bufferUtil_1.BufferUtil.s(t, 0), this.months = bufferUtil_1.BufferUtil.s(t, 4);
            break;

          case o.QUA_MO:
            this.months = bufferUtil_1.BufferUtil.s(t, 4);
    ...
    return o.prototype.encode = function(t) {
        ...
        var s = Buffer.allocUnsafe(12);
        return bufferUtil_1.BufferUtil.f(s, 0, i), bufferUtil_1.BufferUtil.f(s, 4, h), bufferUtil_1.BufferUtil.f(s, 8, t), 
        s;
