...
var buffer_1 = require("../buffer"), error_1 = require("../../driver/error"), const_1 = require("../../desc/const"), events_1 = require("events"), timer_1 = require("../../utils/timer"), svcConf_1 = require("../../desc/svcConf"), Msg = function(_) {
    function M(t, s, i, n) {
        ...
        return r.br = t, r.St = new buffer_1.DmBuffer(M.Mn), r.fr = s, r.fs = 0, r.dr = i, 
    ...
    return __extends(M, _), M.prototype.Kt = function() {
        ...
        this.Dn(), this.jn(), this.En();
    }, M.prototype.Dn = function() {
        this.St.Tt(0), this.St.ri(M.kt, !0, !0);
    }, M.prototype.En = function() {
        this.St.f(M.Tn, this.dr ? this.dr.handle : 0), this.St.B(M.Lt, this.fr), this.St.f(M.ei, this.St.Gt - M.kt);
        ...
        this.St.Jt(M.kt), this.Sn();
    }, M.prototype.On = function() {}, M.prototype.Sn = function() {
        if (this.fs = this.St.s(M.Ln), this.fs < 0) {
            if (this.fs !== error_1.DBError.EC_RN_EXCEED_ROWSET_SIZE().errCode) throw new error_1.DBError(this.fs, (this.br.pt.rwStandby ? "[S] " : "") + this.Rn(), null);
        } else 0 < this.fs || this.fr !== M._r && this.fr !== M.Ms || this.Rn();
        ...
        this.St.ri(this.St.D(), !1, !0), this.St.ri(this.St.D(), !1, !0), this.St.ri(this.St.D(), !1, !0), 
        this.St.Ei(t);
    }, M.prototype.Ht = function() {
        var t, s;
        this.br.dt ? (t = this.Rt(), this.Et(t + M.Nn), s = this.qn(this.St, 0, M.kt + t), 
        this.St.k(s)) : this.St.rn(M.Bn, this.Gn(this.St));
    }, M.prototype.Bt = function() {
        if (this.br.dt) {
            var t = this.Rt() - M.Nn, s = M.kt + t;
            if (this.St.s(s) !== this.qn(this.St, 0, s)) throw error_1.DBError.ECJS_MSG_CHECK_ERROR();
            this.Et(t), this.St.Tt(s);
        } else {
            if (this.St.H(M.Bn) !== this.Gn(this.St)) throw error_1.DBError.ECJS_MSG_CHECK_ERROR();
        }
    }, M.prototype.Gn = function(t) {
        for (var s = t.H(0), i = 1; i < M.Bn; i++) s ^= t.H(i);
        return s;
    }, M.prototype.qn = function(t, s, i) {
        for (var n = 4294967295, r = s, _ = i - s; 8 <= _; ) {
            var h = t.s(r) ^ n;
            r += const_1.Const.ULINT_SIZE;
            var e = t.s(r);
            r += const_1.Const.ULINT_SIZE, n = M.Pn[7][255 & h] ^ M.Pn[6][h >> 8 & 255] ^ M.Pn[5][h >> 16 & 255] ^ M.Pn[4][h >> 24 & 255] ^ M.Pn[3][255 & e] ^ M.Pn[2][e >> 8 & 255] ^ M.Pn[1][e >> 16 & 255] ^ M.Pn[0][e >> 24 & 255], 
            _ -= 8;
        }
        for (;0 < _; ) n = n >> 8 & 16777215 ^ M.Pn[0][255 & n ^ t.H(r)], r++, _--;
        return ~n;
    }, M.prototype.Xn = function() {
        return this.St.U(M.Lt);
    }, M.prototype.Rt = function() {
        return this.St.s(M.ei);
