...
var msg_1 = require("./msg/msg"), MsgParser = function() {
    ...
    return t.prototype.write = function(t) {
        ...
        this._packetHeader); ) {
            var i = this._packetHeader.readInt32LE(msg_1.Msg.ei);
        ...
        if (!this._combineNextBuffers(msg_1.Msg.kt)) return null;
        var t = this._buffer.slice(this._offset, this._offset + msg_1.Msg.kt);
        return this._offset += msg_1.Msg.kt, t;
        ...
        if (t && 0 !== t.length) {
            ...
            if (0 != h) {
                r = Buffer.allocUnsafe(h + u), f = 0, f += this._buffer.copy(r, 0, s, i);
                for (e = 0; e < n.length; e++) f += n[e].copy(r, f);
            } else if (1 < n.length) {
                r = Buffer.allocUnsafe(u);
