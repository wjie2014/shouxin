...
var CacheQueue = function() {
    ...
    }, t.prototype.put = function(r) {
        return __awaiter(this, void 0, void 0, function() {
            var n;
            return __generator(this, function(t) {
                switch (t.label) {
                  case 0:
                    return this.queue.includes(r) ? [ 2, !0 ] : this.queue.length < this.maxSize ? (this.queue.push(r), 
                    [ 2, !0 ]) : [ 3, 1 ];
                  ...
                  case 2:
                    return t.sent(), this.queue.push(r), [ 2, !0 ];

                  case 3:
                    return [ 4, this.beforeRemove(r) ];
